...
String? _adminOrResponsableRedirect() {
  ...
  if (role != UserRole.admin && role != UserRole.responsable) {
    return '/dashboard/bergerie';
  }
  return null;
}
...
final GoRouter appRouter = GoRouter(
  ...
  routes: [
    ...
    GoRoute(
      path: '/dashboard/bergerie',
      builder: (context, state) => const BergerieDashboardPage(),
    ),

    GoRoute(
      path: '/clients',
      redirect: (context, state) => _adminOrResponsableRedirect(),
    ...
    GoRoute(
      path: '/bergeries',
      redirect: (context, state) => _adminResponsableTechnicienRedirect(),
    ...
    GoRoute(
      path: '/interventions',
      redirect: (context, state) => _interventionRedirect(),
    ...
    GoRoute(
      path: '/finances',
      redirect: (context, state) => _adminOnlyRedirect(),
      builder: (context, state) => const FinancesHomePage(),
    ),
    GoRoute(
      path: '/paiements',
      redirect: (context, state) => _adminOnlyRedirect(),
    ...
    GoRoute(
      path: '/creances',
      redirect: (context, state) => _adminOnlyRedirect(),
      builder: (context, state) => const CreancesPage(),
    ),
    GoRoute(
      path: '/dashboard-financier',
      redirect: (context, state) => _adminOnlyRedirect(),
      builder: (context, state) => const DashboardFinancierPage(),
    ),
    GoRoute(
      path: '/rapports-financiers',
      redirect: (context, state) => _adminOrResponsableRedirect(),
      builder: (context, state) => const RapportsFinanciersPage(),
    ),
    GoRoute(
      path: '/utilisateurs',
      redirect: (context, state) => _adminOnlyRedirect(),
