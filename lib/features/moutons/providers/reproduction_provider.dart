...
final reproductionsProvider =
FutureProvider.family<List<ReproductionModel>, String>(
      (ref, moutonId) async {
...
FutureProvider.family<ReproductionModel?, String>(
      (ref, moutonId) async {
    final repository = ref.watch(
      reproductionRepositoryProvider,
    );
...
FutureProvider<List<ReproductionModel>>(
      (ref) async {
    final repository = ref.watch(
      reproductionRepositoryProvider,
    );
