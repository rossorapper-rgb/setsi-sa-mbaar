...
class GestationModel {
  ...
  GestationModel copyWith({
    ...
    return GestationModel(
      ...
      belierExterieur: belierExterieur ?? this.belierExterieur,
      proprietaireBelier: proprietaireBelier ?? this.proprietaireBelier,
      bergerieId: bergerieId ?? this.bergerieId,
      dateSaillie: dateSaillie ?? this.dateSaillie,
      dateProbableMiseBas: dateProbableMiseBas ?? this.dateProbableMiseBas,
      dateMiseBas: dateMiseBas ?? this.dateMiseBas,
      typeSaillie: typeSaillie ?? this.typeSaillie,
  ...
  Map<String, dynamic> toMap() {
    return {
      ...
      'dateProbableMiseBas': Timestamp.fromDate(dateProbableMiseBas),
      'dateMiseBas': dateMiseBas == null ? null : Timestamp.fromDate(dateMiseBas!),
  ...
  factory GestationModel.fromMap(Map<String, dynamic> map, String id) {
    ...
    return GestationModel(
      ...
      belierExterieur: map['belierExterieur'] ?? false,
      proprietaireBelier: map['proprietaireBelier'],
      bergerieId: map['bergerieId'] ?? '',
      dateSaillie: parseDate(map['dateSaillie']),
      dateProbableMiseBas: parseDate(map['dateProbableMiseBas']),
      dateMiseBas: parseNullableDate(map['dateMiseBas']),
      typeSaillie: map['typeSaillie'] ?? '',
      statut: map['statut'] ?? 'En cours',
      nombreAgneaux: (map['nombreAgneaux'] as num?)?.toInt() ?? 0,
      nombreMales: (map['nombreMales'] as num?)?.toInt() ?? 0,
      nombreFemelles: (map['nombreFemelles'] as num?)?.toInt() ?? 0,
