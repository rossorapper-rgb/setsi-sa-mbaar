...
class _AddClientPageState
  ...
  Future<void> _enregistrer() async {
    ...
    try {
      ...
      /*
       * On laisse le StreamProvider clientsProvider
       * récupérer automatiquement le nouveau client.
       *
       * On utilise context.pop() car cette page a été
       * ouverte avec GoRouter.
       */
      context.go('/clients');
    } catch (e) {
      if (!mounted) return;
